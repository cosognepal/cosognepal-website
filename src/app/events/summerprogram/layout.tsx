...
export const metadata: Metadata = {
    ...
    description: `Coding for Social Good Nepal Summer Camp is a 16-week learning fellowship for high school students and recent graduates in Nepal.
    ...
    twitter: {
        ...
        site: "@cosognepal",
        title: "Summer Camp | Coding for Social Good Nepal",
        description: `Coding for Social Good Nepal Summer Camp is a 16-week learning fellowship focused on environment and computer science for students in Nepal.`,
        images: [{
            url: "/assets/images/Events/Empactathon/empactathon_banner.png",
            width: 1200,
            height: 680,
