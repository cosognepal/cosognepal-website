...
import BottomSectionNav from "./BottomSectionNav";
import Footer from "./Footer";
import SupportedBy from "./SupportedBy";
import ProjectsSection from "./ProjectsSection";
import OutcomesSection from "./Outcomes";
import StayConnected from "./StayConnected";
import SessionsTeaser from "./SessionsTeaser";
import { cn } from "@/lib/utils";
import { lora } from "@/lib/fonts";

export default function SummerProgramContent() {
  return (
    <div className="space-y-section">
      ...
      <section id="general-timeline" className="scroll-mt-24">
        <TimeLine
          ...
          tasks={[
            ...
            {
              description:
                "Selected students are notified and mentor updates are announced.",
              icon: "speaker",
            ...
            {
              description:
                "Teams present outcomes and the cohort wraps up with a final showcase.",
              icon: "description",
      ...
      <PrizeSection
        sectionComp={
          <div className={cn("title text-heading font-bold  text-center")}>
            <span className={`${lora.className} text-empactathon-dark`}>
              Our program at a glance
            </span>
            <br />
            <span
              className={`${lora.className} bg-yellow-100 p-1 px-3 text-empactathon-dark`}
            >
        ...
        prizeData={[
          {
            ...
            prizeDescription: (
              <div
                className={
                  "text-empactathon-dark text-6xl md:text-7xl font-extrabold leading-none"
                }
              >
                60
              </div>
      ...
      <section id="mentors" className="scroll-mt-20">
        <GuestsSection
          ...
          className={{
            notPublicYetCard:
              "bg-gradient-to-br to-empactathon-primary/45 min-h-[450px] rounded-md w-full",
            sectionContainer: {
              container:
          ...
          guestData={[
            {
              ...
              designation: "Embedded systems lead, Yatri Motorcycles",
              short_intro: [
            ...
            },
            {
              ...
              designation: "AI Researcher, IOE Pulchowk Campus",
              short_intro: [
            ...
            },
            {
              ...
              designation: "Research @IoT R&D Lab KU × Kyra Works",
              short_intro: [
            ...
            },
            {
              ...
              designation: "Environmental science mentor",
              short_intro: [
      ...
      <section id="faqs" className="scroll-mt-24">
        <FAQ
          ...
          data={[
            ...
            {
              question:
                "Is this opportunity for students inside the Kathmandu Valley only?",
              answer:
