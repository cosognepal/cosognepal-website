...
export default function Belief() {
  return (
    <Section spacing="block" className="bg-paper">
      <Container size="narrow" className="text-center py-block md:py-section">
        <p
          className="font-display font-semibold text-ink-muted leading-[1.25] tracking-tight text-xl md:text-2xl max-w-[58ch] mx-auto"
